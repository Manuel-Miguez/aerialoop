import { areIntervalsOverlapping, max, min, differenceInMinutes, Interval, format } from 'date-fns';

export const dateRangeOverlaps = (dateRange1: Interval, dateRange2: Interval) => {
